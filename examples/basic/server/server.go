...
import (
	...
	pb1 "github.com/bradleyaus/mockymcmockface/examples/basic"
)
...
func (t *TestService) Tester2(ctx context.Context, req *pb1.Request1) (*pb1.Response1, error) {
	r, err := t.responseService.GetResponse("Test", "Tester2", req)
	if err != nil {
		log.Panicln("Error when getting response", "Test", "Tester2")
	}
