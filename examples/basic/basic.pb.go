...
var file_basic_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x31, 0x42, 0x36, 0x5a, 0x34,
	...
	0x6b, 0x66, 0x61, 0x63, 0x65, 0x2f, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x73, 0x2f, 0x62,
...
var file_basic_proto_goTypes = []interface{}{
	...
	(*Request1)(nil),  // 1: test.Request1
	(*Response)(nil),  // 2: test.Response
	(*Response1)(nil), // 3: test.Response1
}
var file_basic_proto_depIdxs = []int32{
	0, // 0: test.Test.Tester:input_type -> test.Request
	1, // 1: test.Test.Tester2:input_type -> test.Request1
	2, // 2: test.Test.Tester:output_type -> test.Response
	3, // 3: test.Test.Tester2:output_type -> test.Response1
